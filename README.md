...
+ Define a function `switchAge` that accepts an age as a parameter. The switch statement should switch on `age` and return `"You are a teenager"` if the age is 13, 14, 15, 16, 17, 18, or 19, and return `"You have an age"` as the default.
